  ...
  return (
    <main className="app">
      ...
      <p className="subtitle">
        Submit an integer. A Lambda worker "works" that many seconds, then reports back. <br /> <br />

        Normally, lambdas have up to <b>1000</b> concurrent executions, but this demo is configured
        to allow only <b>2</b> to make it easier to see tasks queueing up.
